...
public class Constants {
    ...
    public static final List<String> SHIPPING_SUPPORTED_COUNTRIES = Arrays.asList(
            "US", "GB", "IL", "CA", "AU", "DE", "FR", "JP", "CN", "IN", "BR", "MX", "RU", "KR", "IT",
            "ES", "NL", "SE", "CH", "SG", "AE", "SA", "DK", "NO", "PL", "FI", "AT", "BE", "TR", "IE",
            "MY", "PT", "HK", "TH", "ID", "NZ", "ZA", "HU", "GR", "CL", "CZ", "PH", "CO", "AR", "VN",
            "EG", "UA", "RO", "QA", "KW", "PE", "DO", "OM", "CR", "BG", "PA", "HR", "RS", "IL", "MA",
            "EC", "LK", "TN", "SV", "BY", "BA", "GT", "UY", "KZ", "CI", "ET", "LB", "GH", "SD", "VE",
            "NP", "KE", "PA", "SN", "MO", "UG", "JM", "CY", "MU", "GT", "PY", "LY", "AZ", "LU", "SV",
            "BH", "MM", "GM", "MN", "MD", "KG", "TT", "TZ", "BW", "IQ", "BN", "MN", "HT", "SY", "LA",
            "SZ", "BB", "ZM", "AF", "AO", "HT", "BJ", "BW", "BI", "KH", "CM", "CV", "CF", "TD", "KM",
            "CG", "CD", "DJ", "GQ", "ER", "SZ", "LS", "LR", "MG", "MW", "ML", "MR", "MZ", "NA", "NE",
            "NG", "RW", "ST", "SN", "SC", "SL", "SO", "SS", "SD", "SZ", "TG", "TO", "TT", "TN", "TV",
            "UG", "UA", "UZ", "VU", "VE", "VN", "YE", "ZM", "ZW");
